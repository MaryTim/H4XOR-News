...
extension DetailView_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        AnyView(__designTimeSelection(DetailView(url: __designTimeString("#15815.[2].[0].property.[0].[0].arg[0].value.[0].value", fallback: "https://www.google.com")), "#15815.[2].[0].property.[0].[0]"))
#sourceLocation()
    }
}
...
extension DetailView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(__designTimeSelection(Text(__designTimeString("#15815.[1].[1].property.[0].[0].arg[0].value.[0].value", fallback: "Hello, World!")), "#15815.[1].[1].property.[0].[0]"))
#sourceLocation()
    }
}
